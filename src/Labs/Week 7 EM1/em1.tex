...
\begin{document}
    ...
    \section{Ohmic Behavior (Experiment 2A)}\label{sec:current}
...
%    ['I1: 0.236 mA', 'I2: 0.231 mA', 'I3: 0.466 mA']
    ...
    We also found that our data did not obey Kirchoffs Junction rule, as we can clearly see that $I_1$ + $I_2$ does not equal $I_3$. This means our data was off significantly and we should not expect it to be within an acceptable range.
    ...
    \section{Conclusion}\label{sec:current}


    \section{References}\label{sec:current}

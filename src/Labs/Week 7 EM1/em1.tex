...
\begin{document}
    ...
    When graphed, it shows a non-linear relationship between voltage and current, as seen in Figure~\ref{fig:non_ohmic_graph}.
    \begin{figure}[h!]
        \centering
    ...
    \end{figure}
    The red LED data shows similar non-linear relationship between voltage and current, as seen in Figure~\ref{fig:non_ohmic_graph_red}.
    \begin{figure}[h!]
        \centering

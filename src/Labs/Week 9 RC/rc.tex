...
\begin{document}
    ...
    This allows the circuit to be analysed as damped, underdamped, or overdamped, using the ratio $\frac{\alpha}{\omega_0}$.
    ...
    \section{Time Constant With Oscilloscope}\label{sec:measuring-time-constant}
    ...
    Again, the resistance was known, and the capacitance was calculated from the area and separation of the plates.

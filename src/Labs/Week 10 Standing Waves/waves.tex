...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \end{annotatedFigure}
        \caption{Part 1 setup, showing (a) as the string, (b) as the string oscillator, (c) as the pulley and hanging mass, and (d) showing the string being held taught, with more length being fed as needed.}
